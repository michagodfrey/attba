...
const Footer = () => {
  return (
    <footer>
      <ExternalLink
        href={"https://github.com/michagodfrey/attba"}
      ...
      <p>
        If you have questions or just want to reach out about biosecurity or web
        development, my email is m.godfrey59@gmail.com
      </p>
    </footer>
  );
};
